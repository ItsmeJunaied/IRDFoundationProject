        ...
        <div className="drawer drawer-end ">
            ...
            <div className="drawer-content">
                ...
                <label htmlFor="my-drawer-4" className=" drawer-button">
                    <div className=' lg:hidden  bg-secondary rounded-lg w-6 h-6 p-5 flex justify-center items-center'>
                    ...
                    <div className='  flex flex-col w-full h-full justify-end bg-[#101010]'>
                        ...
                        <div className=' relative flex flex-col gap-5   p-6 text-primary bg-[#202020]  '>
                            ...
                            <div className=' flex flex-row justify-between items-center w-full'>
                                ...
                                <div onClick={() => { document.getElementById('my-drawer-4').checked = false; }}>
                        ...
                        <div className=' flex flex-col gap-5 rounded-2xl  p-6 text-primary bg-[#404040] '>
                            <div>
