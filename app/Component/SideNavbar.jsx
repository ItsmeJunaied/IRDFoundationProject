...
const SideNavbar = () => {
    return (
        <div className=' lg:w-[95px]  h-full  bg-ashColor '>
            <div className=' flex flex-col h-screen justify-center items-center align-middle gap-5'>



                <Link href=''>
                    <di className="bg-ashColor hover:bg-[#2C2C2C] rounded-2xl w-6 h-6 p-8 flex justify-center items-center">
                        <FontAwesomeIcon icon={faHouse} size='2xl' className="text-[#A6ACAF] hover:text-secondary" />
                    </di>
                </Link>

                <Link href=''>
                    <div className="bg-ashColor hover:bg-[#2C2C2C] rounded-2xl w-6 h-6 p-8 flex justify-center items-center">
