        ...
        <div className=" bg-[#202020] lg:h-[80px] h-[64px] w-full flex flex-row justify-between items-center align-middle px-4 text-white">
            ...
            <div className=' flex flex-row items-center gap-5'>
                ...
                <div className=' hidden lg:flex flex-col w-fit'>
                    ...
                    <p className=' text-primary text-[13px]'>হাদিস পড়ুন শিখুন এবং জানুন</p>
                </div>

                <div>
                    <h1 className=' md:hidden flex text-secondary font-semibold'>আল হাদিস</h1>
                </div>
            </div>
            ...
            <div className='  flex flex-row lg:gap-16 gap-2'>
                ...
                <div className=' hidden lg:flex'>
                    <button className=' flex flex-row justify-center items-center gap-2 w-[150px] h-[50px] bg-secondary rounded-lg'>
                        ...
                        <div>
                            <Image className=' w-fit' src={support} alt="logo" width={30} height={30} />
                        </div>
                    </button>
                </div>
